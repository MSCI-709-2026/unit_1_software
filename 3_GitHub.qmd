...
You may notice the `Graph` panel in the lower part of the `Source Control` pane has updated, reflecting changes to the timeline of the repo. A nice feature with git is using at the `diff` of your staged or committed files. For example click on the `README.md` file that you committed in the `Graph` panel and you will see a `diff` view pop up in the center pane showing new text added since the previous commit in green, and old text that has been deleted since the previous commit in red.
...
This is especially relevant for our class, because **I have created tutorials and code for each of the class modules and hosted them in repositories on GitHub:** <https://github.com/MSCI-709-2026>
...
-   Click 'Commit'
-   Click 'Sync Changes' to send the commits back to github
